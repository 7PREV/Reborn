...
export default function TournamentDetailPage() {
  ...
  const meetsMinMembers = clanMembersCount >= 6;
  const canJoin = t.status === "registration" && user?.clan_id && !myClanRegistered && meetsMinMembers &&
      ...
      <div className="bg-surface border b-soft rounded-xl p-6 md:p-8">
        <div className="flex items-start gap-5 flex-wrap">
          ...
          <div className="flex gap-2 flex-wrap">
            ...
            {t.status === "registration" && user?.clan_id && !myClanRegistered && !meetsMinMembers && (
