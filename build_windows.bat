...
py -m PyInstaller --clean --noconfirm --onefile --windowed --name RivalsGuard --icon assets\rivalsguard_icon.ico --add-data "assets\rivalsguard_icon.png;assets" guard_client.py
